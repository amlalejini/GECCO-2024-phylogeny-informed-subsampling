# 2023-05-07 - Diagnostics experiments

```{r}
experiment_slug <- "2023-05-07-diagnostics"
...
ggsave(
  ...
  plot = explore_pop_cov_ts + labs(title="Multi-path exploration"),
  width = 10,
  height = 15
)
```
...
```{r}
save_plot(
  filename = paste0(plot_directory, "2023-05-07-diagnostics-con-obj-final-fig.pdf"),
  plot = con_obj_grid,
  base_width = 10,
  base_height = 8,
  dpi = 600
...
```{r}
save_plot(
  filename = paste0(plot_directory, "2023-05-07-diagnostics-explore-final-fig.pdf"),
  plot = explore_grid,
  base_width = 10,
  base_height = 8,
  dpi = 600
