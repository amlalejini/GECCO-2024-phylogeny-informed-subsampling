...
combos.add_val(
    ...
    [
        ...
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.01 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.01 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        ...
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.02 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.02 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.02 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.02 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.02 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.04 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.04 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.04 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.04 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.04 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        ...
        "-EVAL_MODE cohort -NUM_COHORTS 50 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 50 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 50 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 50 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE cohort -NUM_COHORTS 50 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE cohort -NUM_COHORTS 25 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 25 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 25 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 25 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE cohort -NUM_COHORTS 25 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
...
combos.add_val(
    ...
    [
        ...
        "-PROBLEM fizz-buzz -TESTING_SET_PATH fizz-buzz-imbalanced-testing.json -TRAINING_SET_PATH fizz-buzz-imbalanced-training.json -PRG_MAX_FUNC_INST_CNT 64 -EVAL_CPU_CYCLES_PER_TEST 64"
    ]
)
