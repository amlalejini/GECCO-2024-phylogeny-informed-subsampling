...
combos.add_val(
    ...
    [
        ...
        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 100 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 100 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 20 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 20 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort-full-compete -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
