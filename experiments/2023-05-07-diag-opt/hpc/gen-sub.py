...
combos.add_val(
    ...
    [
        ...
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.01 -EVAL_FIT_EST_MODE relative",
        ...
        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE relative",
        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE ancestor"
