...
combos.add_val(
    "eval__COPY_OVER",
    [
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.1 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",

        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor-opt -EVAL_MAX_PHYLO_SEARCH_DEPTH 20",

        "-EVAL_MODE full -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0"
    ]
)
