...
combos.add_val(
    ...
    [
        ...
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE none",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE relative-opt",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.2 -EVAL_FIT_EST_MODE ancestor-opt",
        ...
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE none",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE relative-opt",
        "-EVAL_MODE cohort -NUM_COHORTS 5 -EVAL_FIT_EST_MODE ancestor-opt",
