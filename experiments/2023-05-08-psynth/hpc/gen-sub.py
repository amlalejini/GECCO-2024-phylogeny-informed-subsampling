...
combos.add_val(
    ...
    [
        ...
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.01 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.01 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.05 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.05 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.05 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.10 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.10 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.10 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.50 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.50 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE down-sample -TEST_DOWNSAMPLE_RATE 0.50 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        ...
        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 100 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 20 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 20 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 20 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",
        "-EVAL_MODE cohort -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 5",

        "-EVAL_MODE full -TEST_DOWNSAMPLE_RATE 0.0 -NUM_COHORTS 1 -EVAL_FIT_EST_MODE none -EVAL_MAX_PHYLO_SEARCH_DEPTH 0"

        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 100 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 100 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 20 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 20 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 10 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 10 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",

        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 2 -EVAL_FIT_EST_MODE relative -EVAL_MAX_PHYLO_SEARCH_DEPTH 10",
        # "-EVAL_MODE cohort-full-compete -NUM_COHORTS 2 -EVAL_FIT_EST_MODE ancestor -EVAL_MAX_PHYLO_SEARCH_DEPTH 10"
    ]
)
